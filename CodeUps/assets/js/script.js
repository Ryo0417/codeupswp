jQuery(function ($) {
  ...
  (window).addEventListener('load',function(){
    $(".c-splash__logo").delay(600).fadeOut('slow');//ロゴを1.2秒でフェードアウトする記述

    //=====ここからローディングエリア（splashエリア）を1.5秒でフェードアウトした後に動かしたいJSをまとめる
    $(".c-splash").delay(800).fadeOut('slow',function(){//ローディングエリア（splashエリア）を1.5秒でフェードアウトする記述
    ...
    $('.c-splash__bg').on('animationend', function() { 
    //この中に動かしたいJSを記載
    });
